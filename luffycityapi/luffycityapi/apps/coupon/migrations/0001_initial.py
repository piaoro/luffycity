# Generated by Django 3.2.9 on 2024-05-08 10:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon_type', models.SmallIntegerField(choices=[(0, '通用类型'), (1, '指定方向'), (2, '指定分类'), (3, '指定课程')], default=0, verbose_name='优惠劵类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='to_user', to='coupon.coupon', verbose_name='优惠劵')),
            ...
            options={
                ...
                'verbose_name_plural': '优惠劵发放和使用日志',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('coupon', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='to_direction', to='courses.course', verbose_name='优惠劵')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='to_category', to='coupon.coupon', verbose_name='优惠劵')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='添加时间')),
                ('coupon', models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.CASCADE, related_name='to_course', to='coupon.coupon', verbose_name='优惠劵')),
